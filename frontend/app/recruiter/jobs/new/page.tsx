...
export default function PostNewJob() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.response?.data?.error?.message || "Failed to post job. Please try again.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="p-6 md:p-8 max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Post New Job</h1>
        <p className="text-slate-500 mt-1 text-sm">Fill in the details below to attract top talent.</p>
      </div>
